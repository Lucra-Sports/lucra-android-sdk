...
The Activity that hosts Add Funds / Withdraw Funds must use the default application
`taskAffinity`. See [Host Activity Requirements](1.0.0_project_setup.md#task-affinity).
