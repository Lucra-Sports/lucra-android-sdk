...
LucraClient.initialize(
  ...
  clientTheme = ClientTheme(
    ...
    // Optional. ThemeMode.LIGHT, ThemeMode.DARK, or ThemeMode.AUTO.
    // When omitted, appearance is derived from the color styles you supply: both follow the
    // device, light-only locks light, otherwise locks dark. See [Theming/Appearance](1.2.1_theming.md)
