...
- **Parameters:**
  - `contest`: `Context` Context of the Service
...
Within the Activity you specified above in `activityClass`, handle the incoming `Intent` and parse the Lucra specific notification to show a `LucraFlow`. Add `handleNotificationIntent` to the following locations.
